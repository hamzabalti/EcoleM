 ...
 * @author acer
// */
public class ApprenantFovorisForm extends Form{

 public ApprenantFovorisForm() {
        
                      super("Votre Fovoris", BoxLayout.y());
 ...
 for(Emploi e1:ServiceEmploitApprenant.getInstance().AfficherFavoris(MyApplication.u.getId())){
